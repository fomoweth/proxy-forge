...
contract ProxyForge is IProxyForge {
    ...
    /// @inheritdoc IProxyForge
    function deployAndCall(address implementation, address owner, bytes calldata data)
        external
        payable
    ...
    /// @inheritdoc IProxyForge
    function deployDeterministic(address implementation, address owner, bytes32 salt)
        external
        payable
        returns (address proxy)
    {
    ...
    /// @inheritdoc IProxyForge
    function deployDeterministicAndCall(address implementation, address owner, bytes32 salt, bytes calldata data)
        external
        payable
        returns (address proxy)
    {
    ...
    function _deploy(address implementation, address owner, bytes32 salt, bool isDeterministic, bytes calldata data)
        internal
        returns (address proxy)
    {
    ...
    /// @inheritdoc IProxyForge
    function computeProxyAddress(address implementation, bytes32 salt, bytes calldata data)
        external
        view
        returns (address proxy)
    {
